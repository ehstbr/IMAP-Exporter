...
<p align="center">
  <img alt="Versão 0.5.5" src="https://img.shields.io/badge/vers%C3%A3o-0.5.5-3584e4">
  <img alt="Licença GNU GPLv3" src="https://img.shields.io/badge/licen%C3%A7a-GPLv3-26a269">
...
- Verificação automática silenciosa de atualizações pelo GitHub e ação manual
  ...
  obrigatória, ícones distintos, botões de ação reais, resumo da release e uma
  visualização própria para o changelog completo.
...
```bash
sudo apt install ./imap-exporter_0.5.5_all.deb
```
...
- [Manifesto de atualização e publicação](docs/UPDATES.pt-BR.md)
...
Distribuído sob a [GNU General Public License versão 3](LICENSE).
